...
| [0022](0022-stale-copies-that-cannot-cover-the-since-window.md) | A stale copy that cannot cover the `since` window | Proposed |
| [0023](0023-cooldown-escalation-decays-rather-than-resets.md) | Cooldown escalation should decay, not reset | Proposed |
